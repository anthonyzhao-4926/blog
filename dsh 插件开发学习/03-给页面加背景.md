...
> **前置**：[第一个插件](02-第一个插件.md)。约 25 分钟。

[上一篇](02-第一个插件.md)的 hello world 只是打印一句话，没啥吸引力，我们再练习一个设置聊天背景的插件。实现如下效果
...
**下一篇**：[effect 与插件生命周期](04-effect与生命周期.md)——把这篇里 `ctx.effect` 那几行为什么非写不可讲透。

...
# == dsh-hello-word
- id: dsh-hello-word
  name: /绝对路径/dsh-hello-word.ts
```

然后启动 DSH，日志里出现 `hello word`。
![](assets/Pasted%20image%2020260831213904.png)